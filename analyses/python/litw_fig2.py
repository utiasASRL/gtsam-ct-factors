...
if __name__ == "__main__":
    ...
    path_gt_red = "analyses/results/lost_fig2_gt.csv"
    path_solve = "analyses/results/lost_fig2_gtsam.csv"
    ...
    plot_landmarks(ax)
    plot_se2_trajectory(ax, path_gt_red, None, gt_vals=True, downsample=downsample)
