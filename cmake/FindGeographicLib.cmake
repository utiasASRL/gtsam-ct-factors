...
#
# Set GeographicLib_FOUND = GEOGRAPHICLIB_FOUND = TRUE
# GeographicLib_INCLUDE_DIRS = /usr/local/include GeographicLib_LIBRARIES =
# /usr/local/lib/libGeographic.so GeographicLib_LIBRARY_DIRS = /usr/local/lib
...
if(GeographicLib_LIBRARIES)
  ...
  if(NOT EXISTS "${GeographicLib_INCLUDE_DIRS}/GeographicLib/Config.h")
    ...
    # /usr/lib/x86_64-linux-gnu/libGeographic.so so try stripping another
    # element off _ROOT_DIR
...
find_package_handle_standard_args(
  GeographicLib DEFAULT_MSG GeographicLib_LIBRARY_DIRS GeographicLib_LIBRARIES
