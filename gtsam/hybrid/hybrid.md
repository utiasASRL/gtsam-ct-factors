...
The `hybrid` module provides classes and algorithms specifically designed for inference in probabilistic graphical models involving both discrete and continuous variables. It extends the core concepts from the `inference` module to handle these mixed variable types, enabling the modeling and solving of systems with discrete modes, decisions, or states alongside continuous states.
...
## Hybrid Factors and Conditionals
